...
if ( ! function_exists( 'kr_include_theme_options' ) && class_exists( 'ReduxFramework' ) ) {
    function kr_include_theme_options() {
        // Use this to override Redux Framework
        if ( file_exists( get_template_directory() . '/framework/core/kr_reduxframework.php' ) ) {
    ...
    kr_include_theme_options();
}

// Include core files
if ( ! function_exists( 'kr_include_core_files' ) ) {
    function kr_include_core_files() {
        ...
        if ( true == kr_check_woocommerce_status() ) {
